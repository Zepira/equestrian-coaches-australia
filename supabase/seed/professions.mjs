...
export const PROFESSIONS = [
  ...
  horseCare({
    ...
    // "Physiotherapist" is a protected title, even for work on animals
    // (content/handbook/marketing-engine.html §05.12): usable on a profile
    // only once the registration has been checked.
    name: "Equine physiotherapy",
    short_name: "Physiotherapy",
    blurb: "Rehabilitation and movement work, usually alongside your vet.",
    glyph_key: "physiotherapists",
    singular: "physiotherapy practitioner",
    plural: "physiotherapy practitioners",
    job_title: "Equine physiotherapy practitioner",
    protected_titles: ["physiotherapist", "physiotherapists", "physio", "physios"],
  ...
  horseCare({
    slug: "chiropractors",
    name: "Equine chiropractic",
    short_name: "Chiropractic",
    blurb: "Equine chiropractic and osteopathic adjustment.",
    glyph_key: "chiropractors",
    singular: "chiropractic practitioner",
    plural: "chiropractic practitioners",
    job_title: "Equine chiropractic practitioner",
    protected_titles: ["chiropractor", "chiropractors", "chiro", "chiros"],
