...
const base =
  "press inline-flex items-center justify-center gap-2 rounded-[var(--radius-control)] text-[15px] font-semibold px-6 py-3 transition-colors disabled:opacity-50 disabled:pointer-events-none";
