...
export const CONTENT_DEFAULTS = {
  ...
  "legal.privacy": {
    ...
    sections: [
      ...
      { title: "How long we keep it", body: "For as long as your account is open. When an account is deleted, its profile, alerts, saved profiles and enquiries go with it. An enquiry's name, contact details and message are deleted {enquiry_months} months after it was sent, whether or not the accounts are still open; the professional's count of enquiries stays. We may keep billing records for as long as tax law requires." },
