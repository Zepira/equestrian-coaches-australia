...
function toCard(coach: MockCoach, distanceKm: number | null): MockCoachCard {
  return {
    ...
    skillNames: [...coach.skillSlugs.map((s) => SKILL_NAMES[s] ?? s)].sort((a, b) => a.localeCompare(b)),
    attributeNames: [...coach.attributeSlugs.map((s) => ATTRIBUTE_NAMES[s] ?? s)].sort((a, b) => a.localeCompare(b)),
