      ...
      <form action={action} className="flex flex-col gap-6">
        ...
        <section className="flex flex-col gap-4 border-t border-border pt-6">
          ...
          <div className="rounded-[12px] border border-border bg-bg px-4 py-3">
            ...
            <p className="mt-1.5 truncate text-[17px] text-[#1a0dab]">{seo.title} | Equestrian Coaches Australia</p>
            <p className="text-[13px] text-[#006621]">equestriancoaches.au › disciplines › {discipline.slug}</p>
