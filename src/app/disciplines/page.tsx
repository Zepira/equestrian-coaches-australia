...
export const metadata: Metadata = {
  title: "Disciplines",
  description:
    "Every riding discipline with coaches listed on Equine Professionals Australia — dressage, Western, liberty, show jumping, eventing, campdrafting and more. Pick yours and search by location.",
};
        ...
        <div className="wide:grid wide:grid-cols-[1.3fr_1fr] wide:items-end wide:gap-14">
          ...
          <div className="fade-in mt-5 flex flex-col gap-3 text-[16px] leading-[1.55] text-muted wide:mt-0 wide:pb-3 wide:text-[17px]" style={{ animationDelay: "0.6s" }}>
            ...
            <p className="text-[14px] text-subtle">
              Missing yours?{" "}
              <a href="mailto:hello@equineprofessionals.au?subject=A%20discipline%20to%20add" className="border-b border-current text-accent hover:text-accent-hover">
                Tell us
              </a>{" "}
