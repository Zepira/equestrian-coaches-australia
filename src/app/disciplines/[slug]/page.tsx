        ...
        {coaches.length > 0 ? (
          ...
          <div className="mt-6 rounded-[16px] bg-shade px-6 py-8 wide:px-9 wide:py-10">
            <p className="max-w-[54ch] text-[16px] leading-[1.55] text-muted">
              ...
              <a href={`mailto:hello@equestriancoaches.au?subject=${encodeURIComponent(`A ${lower} coach you should know about`)}`} className="border-b border-current text-accent hover:text-accent-hover">
                tell us
              </a>
              .
            </p>
